...
COLUMN_NUMBERS = {
    ...
    6:  range(41, 51),   # 第六列   41~50（41-46矮储液槽，47-50小瓶子）
    7:  range(51, 55),   # 第七列   51~54（大瓶）
    8:  range(55, 59),   # 第八列   55~58（大瓶）
    9:  range(59, 64),   # 第九列   59~63（1250ul枪头盒）
    10: range(64, 69),   # 第十列   64~68（1250ul枪头盒）
    11: range(69, 74),   # 第十一列 69~73（1250ul枪头盒）
    12: range(74, 79),   # 第十二列 74~78（300ul枪头盒）
}
# 抓取数字 → 列号（反查表）+

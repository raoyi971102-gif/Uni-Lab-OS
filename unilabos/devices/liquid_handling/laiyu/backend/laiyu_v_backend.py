...
# rclpy.init()
    ...
    async def pick_up_tips(self, ops: List[Pickup], use_channels: List[int], **backend_kwargs):
        ...
        self.hardware_interface.xyz_controller.move_to_work_coord_safe(
            z=self.hardware_interface.xyz_controller.machine_config.safe_z_height, speed=100)
    ...
    async def drop_tips(self, ops: List[Drop], use_channels: List[int], **backend_kwargs):
        ...
        self.hardware_interface.xyz_controller.move_to_work_coord_safe(
            z=self.hardware_interface.xyz_controller.machine_config.safe_z_height)
    ...
    async def aspirate(
        ...
        **backend_kwargs,
        ...
        if self.hardware_interface.current_volume + ops[0].volume + blow_out_air_volume > self.hardware_interface.max_volume:
            self.hardware_interface.logger.error(
                f"吸液量超过枪头容量: {self.hardware_interface.current_volume + ops[0].volume} > {self.hardware_interface.max_volume}")
            return
    ...
    async def dispense(
        ...
        **backend_kwargs,
        ...
        if self.hardware_interface.current_volume - ops[0].volume - blow_out_air_volume < 0:
            self.hardware_interface.logger.error(
                f"排液量超过枪头容量: {self.hardware_interface.current_volume - ops[0].volume - blow_out_air_volume} < 0")
            return
